<?php
ob_start();
define('API_KEY','265691584:AAHm5gim38i05BXIpKL6iT-chzDOB_UWmt8');
$admin = "110539965";
$admin2 = "233503938";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'amir_frd_prg','url'=>'https://telegram.me/amir_frd_prg']
        ],
        [
          ['text'=>'cyber_loca','url'=>'https://telegram.me/cyber_loca']
        ]
      ]
    ])
  ]);
